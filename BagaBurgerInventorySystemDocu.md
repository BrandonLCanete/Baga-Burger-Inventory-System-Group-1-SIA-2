...
| **2**   | **Staff**  | **Order Management Module:** <br> 1. View active orders (Order number, Customer details, Order items) <br> - **Order Status Module:** <br> 2. Update order status (e.g., "In Preparation," "Ready for Pickup") | 1. Staff is to view and manage active orders.<br> 2. Staff is to update the status of orders. |
