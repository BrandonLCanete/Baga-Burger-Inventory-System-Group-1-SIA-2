...
|         | Admin      | **Order Management Module** <br> - View and manage active orders (Order number, Customer details, Order items) | 1. Admin is to view and manage active orders. <br> 2. Admin should be able to filter orders by status, date, or customer. <br> 3. Admin should have the ability to edit or cancel orders if necessary. |
