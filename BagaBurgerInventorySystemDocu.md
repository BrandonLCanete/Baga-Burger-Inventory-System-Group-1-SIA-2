...
|         | 	       | **Order Management Module** <br> - View and manage active orders (Order number, Customer details, Order items) | 1. Admin is to view and manage active orders. |
|        |  	       | **Order Status Module** <br> - Update order status (e.g., "In Preparation," "Ready for Pickup") |  Admin is to update the status of orders. |
|         |  	       | **Inventory Alert System** <br> - Receive alerts when stock is low and handle external ordering |  |
|         | 	       | **Messaging System** <br> - Receive messages from users (Staff) for updates, issues, or reports |  |
| 1       | Staff      | **Menu Management Module** <br> - Add or update menu items with: <br> a. Item name <br> b. Price <br> c. Description <br> d. Image |  Staff is to manage menu items. |
|         |            | **Reporting Module** <br> - Create reports such as: <br> a. Sales Reports <br> b. Daily/Weekly/Monthly Reports |  Staff is to create and manage reports. |
|         |            | **Inventory Alert System** <br> - Generate alert messages when stock is low |  Staff is to generate alert messages for low stock. |
